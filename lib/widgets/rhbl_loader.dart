...
class RHBLLoader extends StatefulWidget {
  ...
  @override
  State<RHBLLoader> createState() => _RHBLLoaderState();
}

class _RHBLLoaderState extends State<RHBLLoader>
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              _buildRollstuhlhandballBundesligaText(),
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Transform.rotate(
          angle: _controller.value * 0.0 * 3.14159,
          child: Image.asset(
            'logo.png',
            width: widget.size,
            height: widget.size,
  ...
  Widget _buildRollstuhlhandballBundesligaText() {
    return const Text(
